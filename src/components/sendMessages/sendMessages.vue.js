...
const fileContentExtractorRef = ref();
// 计算按钮是否应该被禁用
...
if (__VLS_ctx.messagesLength > 0) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "flex items-end pl-4 text-gray-400 text-[12px] mr-auto" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.handleNewDialogue) },
        type: "button",
...
if (__VLS_ctx.messagesLength < 1 && !props.isShalow) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "fixed w-full h-full top-0 bottom-0 left-0 right-0 z-[9999] bg-white" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "max-w-[750px] h-full flex flex-col items-center justify-center m-auto relative" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.h1, __VLS_intrinsicElements.h1)({
        ...{ class: "text-[20px] font-bold text-red-700 text-center mb-2" },
    });
    (props.title);
    ...
    var __VLS_0 = {};
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "box-border flex justify-center items-center px-4 mb-8 w-full" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    // @ts-ignore
    const __VLS_2 = __VLS_asFunctionalComponent(FileContentExtractor, new FileContentExtractor({
        ...{ 'onFileContentExtracted': {} },
        ref: "fileContentExtractorRef",
        modelValue: (__VLS_ctx.claim),
    }));
    ...
    /** @type {typeof __VLS_ctx.fileContentExtractorRef} */ ;
    var __VLS_9 = {};
    var __VLS_4;
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
        ...{ onKeypress: (__VLS_ctx.handleSendMessage) },
        type: "text",
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...
        ...{ class: ([
                ...
                __VLS_ctx.isButtonDisabled
                    ? 'bg-gray-400 cursor-not-allowed'
                    : 'bg-[#e23338] cursor-pointer hover:bg-[#d12329]',
            ]) },
        disabled: (__VLS_ctx.isButtonDisabled),
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
        t: "1753668793186",
        ...{ class: "icon" },
    ...
    if (__VLS_ctx.messagesLength < 1 && !props.isShalow) {
        ...
        /** @type {[typeof FileContentExtractor, ]} */ ;
        // @ts-ignore
        const __VLS_13 = __VLS_asFunctionalComponent(FileContentExtractor, new FileContentExtractor({
            ...{ 'onFileContentExtracted': {} },
            ref: "fileContentExtractorRef",
            modelValue: (__VLS_ctx.claim),
        }));
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "absolute bottom-[50px] text-gray-400 flex items-end text-[14px]" },
        });
    }
}
if (__VLS_ctx.messagesLength > 0 || props.isShalow) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    /** @type {[typeof FileContentExtractor, ]} */ ;
    // @ts-ignore
    const __VLS_22 = __VLS_asFunctionalComponent(FileContentExtractor, new FileContentExtractor({
        ...{ 'onFileContentExtracted': {} },
        ref: "fileContentExtractorRef",
        modelValue: (__VLS_ctx.claim),
    }));
...
/** @type {__VLS_StyleScopedClasses['max-w-[750px]']} */ ;
...
/** @type {__VLS_StyleScopedClasses['icon']} */ ;
// @ts-ignore
var __VLS_1 = __VLS_0, __VLS_10 = __VLS_9, __VLS_12 = __VLS_11, __VLS_21 = __VLS_20, __VLS_30 = __VLS_29;
var __VLS_dollars;
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            claim: claim,
            fileContentExtractorRef: fileContentExtractorRef,
...
//# sourceMappingURL=sendMessages.vue.js.map
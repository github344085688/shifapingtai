<template>
  ...
  <div
    ...
    class="fixed bottom-0 left-0 z-[9999] right-0 w-full bg-white p-2.5 flex justify-between items-center shadow-[0_-2px_10px_rgba(0,0,0,0.05)]"
  >
    <button
...
import { isShallow, ref, watch } from 'vue'

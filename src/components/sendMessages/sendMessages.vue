<template>
  ...
  <div
    ...
    class="flex flex-col justify-center items-center px-4 w-full h-screen z-[9999]"
  >
  ...
  <div
    ...
    class="fixed bottom-0 left-0 z-[9999] right-0 w-full bg-white p-2.5 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]"
  >
    <div class="flex relative justify-between items-center">
      <div class="absolute right-0 -left-2 -top-[54px]" v-if="messagesLength > 0">
        <button
          type="button"
          class="whitespace-nowrap bg-white px-3 flex items-center justify-center text-gray-500 border-none rounded-[10px] py-[10px] text-sm cursor-pointer mr-2"

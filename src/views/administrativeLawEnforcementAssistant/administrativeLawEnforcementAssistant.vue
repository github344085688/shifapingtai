<template>
  <div class="w-full min-h-full pb-[68px] bg-gray-50">
    ...
    <SendMessages
      ...
      :title="administrativeLawEnforcementAssistant.title"
      :placeholder="administrativeLawEnforcementAssistant.placeholder"
      :note="administrativeLawEnforcementAssistant.note"
    />
...
onMounted(() => {
  ...
  // 页面渲染前判断缓存是否有效
  if (
    globalState.administrativeLawEnforcementAssistant.aiResults &&

...
onMounted(() => {
    ...
    if (globalState.defenseStrategy.aiResults)
        messages.value = globalState.defenseStrategy.aiResults;
    // 监听用户滚动事件
...
const __VLS_0 = __VLS_asFunctionalComponent(SendMessages, new SendMessages({
    ...
    title: (__VLS_ctx.defenseStrategy.title),
    placeholder: (__VLS_ctx.defenseStrategy.placeholder),
    note: (__VLS_ctx.defenseStrategy.note),
}));
...
//# sourceMappingURL=defenseStrategy.vue.js.map
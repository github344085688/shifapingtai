...
const __VLS_0 = __VLS_asFunctionalComponent(SendMessages, new SendMessages({
    ...
    title: (__VLS_ctx.litigationStrategyGeneration.title),
    placeholder: (__VLS_ctx.litigationStrategyGeneration.placeholder),
    note: (__VLS_ctx.litigationStrategyGeneration.note),
}));
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            AiText: AiText,
            litigationStrategyGeneration: litigationStrategyGeneration,
...
//# sourceMappingURL=litigationStrategyGeneration.vue.js.map
                  ...
                  <div v-if="message.selectedConcurrentResult === result.key" class="px-3 pb-3">
                        ...
                        <details>
                          ...
                          >
                            ...
                            <span class="ml-2 text-xs text-gray-500"
                              >相关性: {{ (Number(viewItem._score || 0) * 100).toFixed(1) }}%</span
                            >
                          </summary>
                          <div class="px-3 pb-3">
                            <div class="mt-2 leading-relaxed text-gray-700 whitespace-pre-wrap">
                    ...
                    >
                      <div
                        ...
                        :key="index"
                        class="p-4 mb-4 bg-white rounded-lg border border-gray-200 shadow-sm"
                      >
                        ...
                        <div v-if="caseItem.abstract" class="mb-3">
                          <details>
                            <summary class="px-3 py-2 rounded cursor-pointer hover:bg-gray-50">
                              <span class="text-[15px] font-medium text-gray-800">案件摘要</span>
                            </summary>
                            <div
                        ...
                        >
                          <details>
                            <summary class="px-3 py-2 rounded cursor-pointer hover:bg-gray-50">
                              <span class="text-[15px] font-medium text-gray-800">高亮节选</span>
                            </summary>
                    ...
                    <template v-else-if="Array.isArray(getParsedContent(result.content))">
                      ...
                      >
                        <details>
                          ...
                          >
                            <div class="flex-1">
                              <div class="text-[15px] font-medium text-gray-800" v-if="item.title">
                                {{ item.title }}
                              </div>

...
const router = createRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            component: () => import('../views/bigDataVictoryAssessmentReport/bigDataVictoryAssessmentReport.vue'),
            meta: {
        ...
        },
        {
            ...
            component: () => import('../views/litigationStrategyGeneration/litigationStrategyGeneration.vue'),
            meta: {
        ...
        },
        {
            ...
            component: () => import('../views/administrativeLawEnforcementAssistant/administrativeLawEnforcementAssistant.vue'),
            meta: {
        ...
        },
        {
            ...
            component: () => import('../views/administrativePenaltyAssistance/administrativePenaltyAssistance.vue'),
            meta: {

...
class AIService {
    ...
    // 修改sendToAI方法使用重试机制
    async sendToAI(message, callback, lastMessage) {
        // 添加调试信息
                                        ...
                                        if (additionalData.data && additionalData.data.trim()) {
                                            try {
                                                ...
                                                if (resData.content) {
                                                    ...
                                                    // 处理搜索结果的特殊格式
                                                    formattedContent = TextProcessor.processSearchResultContent(formattedContent, resData.title);
    ...
    processSearchResultContent(content, title) {
...
//# sourceMappingURL=searchTheWholeWebAiservis.js.map
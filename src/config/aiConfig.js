...
//法律问题咨询
export const ConsultationOnLegalIssues = {
    key: 'flwtzx',
    name: '法研智答',
    api: apiMap.flwtzx,
    model: '中国法研LLM',
...
export const LawsAndRegulations = {
    key: 'flfgzx',
    name: '法律法规',
    api: apiMap.flfgzx,
    model: '中国法研LLM',
...
export const legalDocumentWriting = {
    key: 'flwsxz',
    name: '法律文书写作',
    api: apiMap.flwsxz,
    model: '中国法研LLM',
...
export const litigationStrategyGeneration = {
    key: 'ssclsc',
    name: '诉讼策略生成',
    api: apiMap.ssclsc,
    model: '中国法研LLM',
...
export const litigationStrategy = {
    key: 'flfxjy',
    name: '法律分析意见-诉讼策略',
    api: apiMap.flfxjy,
    model: '中国法研LLM',
...
export const bigDataVictoryAssessmentReport = {
    key: 'dsjsspgbg',
    name: '法律分析意见抗辩策略',
...
export const administrativeLawEnforcementAssistant = {
    key: 'xzzfzs',
    name: '行政执法助手',
    api: apiMap.xzzfzs,
    model: '中国法研LLM',
...
export const administrativePenaltyAssistance = {
    key: 'xzfcfz',
    name: '行政处罚辅助',
    api: apiMap.xzfcfz,
    model: '中国法研LLM',
